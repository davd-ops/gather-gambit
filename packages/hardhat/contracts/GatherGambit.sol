 ...
 */
contract GatherGambit is IGatherGambit, ERC721AQueryable, Ownable {
    ...
    function mint(address _address) external {
        if (_nextTokenId() > 1000 && msg.sender != _reproductionContract)
            revert OnlyReproductionContractCanMint();
    ...
    function tokenURI(
        ...
        public
        view
        override(IERC721A, ERC721A, IGatherGambit)
